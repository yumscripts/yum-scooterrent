...
CreateThread(function()
	...
	AddTextComponentString('YUM Scooter Rental')
...
CreateThread(function()
    exports['qb-target']:AddTargetModel(Config.PedModel, {
        options = {
            { 
                type = "client",
                event = "yum-scooterrent:client:ScooterMenu",
                icon = "fas fa-bicycle",
                label = "Rent Scooter",
            },
        },
...
RegisterNetEvent('yum-scooterrent:client:ScooterMenu', function()
    local ScooterMenu = {
        {
        ...
        },
        {
            ...
            params = {
                event = "yum-scooterrent:client:Spawn",
                args = {
        ...
        },
		{
            ...
            params = {
                event = "yum-scooterrent:client:Return",
			}
		},
		{
            header = "< Close",
...
RegisterNetEvent('yum-scooterrent:client:Spawn', function(model)
    local model = Config.ScooterModel
    local player = PlayerPedId()
    QBCore.Functions.TriggerCallback('yum-scooterrent:server:RentCheck', function(CanRent)
        if CanRent then 
...
RegisterNetEvent('yum-scooterrent:client:Return', function()
